                        ...
                        struct os_mbuf *buf)
{
    ...
    net_buf_simple_add_u8(msg, _state);
                        ...
                        struct os_mbuf *buf)
{
    ...
    if ((_state != new_state) && (model->pub->addr != BT_MESH_ADDR_UNASSIGNED)) {
...
static const struct bt_mesh_model_op _oosvr_op[] = {
...
static struct bt_mesh_model_pub _oosvr_pub;

static struct bt_mesh_model _models_oosvr[] = {
    BT_MESH_MODEL(BT_MESH_MODEL_ID_GEN_ONOFF_SRV, _oosvr_op,
                  &_oosvr_pub, (void *)42),
};

static struct bt_mesh_elem elements[] = {
    BT_MESH_ELEM(0, root_models, vnd_models),
    BT_MESH_ELEM(0, _models_oosvr, BT_MESH_MODEL_NONE),
};
...
nimble_host_task(void *param)
{
    ...
    _oosvr_pub.msg = NET_BUF_SIMPLE(2 + 2);
